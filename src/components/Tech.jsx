    ...
    <>
      ...
      <div className="flex flex-row flex-wrap justify-center gap-10 mt-15">
        {technologies.map((technology) => (
          <div
            className="w-28 h-28 bg-gray-700/80 rounded-full flex flex-col items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 hover:bg-gray-600/80 hover:shadow-lg hover:shadow-gray-500/20"
            key={technology.name}
          >
