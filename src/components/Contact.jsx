          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-6 justify-center">
              ...
              <button
                ...
                className="flex items-center gap-3 bg-gradient-to-r from-[#0077B5] to-[#005885] hover:from-[#005885] hover:to-[#004065] text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105"
              >
              ...
              <button
                ...
                className="flex items-center gap-3 bg-gradient-to-r from-[#E4405F] via-[#F56040] to-[#FFDC80] hover:from-[#C13584] hover:via-[#E1306C] hover:to-[#F56040] text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
